...
urlpatterns = [
    ...
    path('changeName/<int:itemid>', views.changeMenuName, name = 'changeMenuName'),
    path('changeNutrition/<int:itemid>', views.changeMenuNutrition, name='changeNutritionalInfo'),
